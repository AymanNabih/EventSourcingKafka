...
{
    public class PostPublishedDomainEventHandler : RequestHandler<PostPublishedDomainEvent>
    {
        ...
        protected override void Handle(PostPublishedDomainEvent domainEvent)
        {
