...
{
    public class PostContentUpdatedEventHandler : RequestHandler<PostContentUpdatedDomainEvent>
    {
        ...
        protected override void Handle(PostContentUpdatedDomainEvent domainEvent)
        {
